...
function Upgrades:render()
    ...
    --     upgradeChildren[pageNumber][upgrade.Description..game:GetService("HttpService"):GenerateGUID(false)] = e(UpgradeFrame, {
    --         upgrade = upgrade,
    ...
    -- upgradeChildren[self.props.currentpage].UICorner = e("UICorner")

    -- upgradeChildren[self.props.currentpage].UIGridLayout = e("UIGridLayout", {
    ...
    --         ZIndex = 2
    --     }, upgradeChildren[self.props.currentpage]),
...
return RoactRodux.connect(
    function(state, _)
        return {
            menu = state.menu,
            upgradepage = state.playerdata.upgradepage,
